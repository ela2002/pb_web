...
const JobCard = ({ job, userId }) => {
  const { id, title, companyName,companyId, companyLogoUrl,Salary, location, description, postedDate, requirements } = job;
  ...
  return (
    <div className={styles.jobCard}>
      ...
      <div className={styles.imageContainer}>
        <img src={companyLogoUrl} alt="Company Logo" className={styles.image} />
      </div>
      ...
      <div className={styles.jobDetails}>
        ...
        <p className={styles.location}><span>Salary:</span> {Salary}</p>
     ...
     {/*   <button className={styles.detailsButton} onClick={() => navigateToJobDetails(id)}>
            View Details
          </button>*/} 
